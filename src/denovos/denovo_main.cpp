...
void print_usage(){
  std::cerr << "Usage: DenovoFinder --fam <fam_file> --str-vcf <str_gts.vcf.gz> --denovo-vcf <denovos.vcf.gz> [OPTIONS]" << "\n" << "\n"
	    ...
	    << "\t" << "--str-vcf    <str_gts.vcf.gz>      "  << "\t" << "Bgzipped input VCF file containing STR genotypes previously generated by HipSTR-MT"      << "\n"
	    ...
	    << "\t" << "                                   "  << "\t" << " NOTE: This is the preferred option if you ran HipSTR-MT with --snp-vcf and "            << "\n"
