...
def main():
     ...
     parser.add_argument("--vcf",              help="Input VCF containing STR genotypes generated by HipSTR-MT", type=str, required=True, dest="VCF")
     ...
     # to the HipSTR-MT VCF such that they're appropriately output to the VCF header for the new file
     ...
     # Iterate through the HipSTR-MT genotype VCF line-by-line
